...
namespace CLauncher2._0
{
    ...
    /// </summary>
    public partial class frmPatcher : Window
    {


        private readonly string Version = "0.901";
        private WebClient client = new WebClient();
        private Stopwatch dlrate = new Stopwatch();
        private string URL = "https://elygate.com/APB-CLauncher/";
        private string AppName = "APB CLauncher.exe";
        private string OldAppName = "APB CLauncher_old.exe";
        private string DL = "https://elygate.com/APB-CLauncher/APB CLauncher.exe";
